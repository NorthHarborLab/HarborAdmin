...
{
    /// <summary>JSON 中消息类型字段名。</summary>
    public const string TypePropertyName = "type";

    /// <summary>消息类型，见 <see cref="ConfigMessageTypes"/>。</summary>
    ...
    /// <summary>客户端实例 ID（握手时使用）。</summary>
    [JsonPropertyName("clientId")]
    public string? ClientId { get; set; }

    /// <summary>配置版本号；<c>getConfig</c> 请求中 0 表示最新。</summary>
    [JsonPropertyName("version")]
    public int Version { get; set; }

    /// <summary>发布记录主键（<c>publishNotify</c> 使用）。</summary>
    [JsonPropertyName("releaseId")]
    public long ReleaseId { get; set; }

    /// <summary>扁平化配置键值对（<c>getConfigResponse</c> 使用）。</summary>
    [JsonPropertyName("data")]
    public Dictionary<string, string>? Data { get; set; }

    /// <summary>操作是否成功（握手确认、publishNotifyAck 等）。</summary>
    [JsonPropertyName("ok")]
    public bool Ok { get; set; }

    /// <summary>错误码（<c>error</c> 类型）。</summary>
    [JsonPropertyName("code")]
    public string? Code { get; set; }

    /// <summary>错误或描述信息。</summary>
    [JsonPropertyName("message")]
    public string? Message { get; set; }

    /// <summary>JSON 序列化选项（camelCase，忽略 null）。</summary>
    ...
    /// <summary>构造心跳请求。</summary>
    public static ConfigMessage PingRequest() =>
        new() { Type = ConfigMessageTypes.Ping };

    /// <summary>将消息编码为完整 TCP 帧（4 字节大端长度 + UTF-8 JSON）。</summary>
    ...
    /// <summary>从帧 payload 反序列化消息。</summary>
