...
public sealed record ConfigApplicationDto(long Id, string AppId, string Name, string? Description, DateTime CreatedAt);
...
/// <param name="Version">版本号</param>
/// <param name="Data">扁平化键值对（键格式 <c>Group:Key</c>）</param>
