...
public sealed record TaskCallableDescriptor(string FullClassName, string ServiceKey, string MethodKey, string DisplayName, Type RequestType, Type ResponseType);
