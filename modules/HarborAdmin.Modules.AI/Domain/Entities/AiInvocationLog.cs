...
/// </summary>
[DbKey("AdminDb")]
[Index("ux_ai_invocation_id", "InvocationId", true)]
[Index("ux_ai_invocation_idempotency", "BusinessKey,ProducerKey,IdempotencyKey", true)]
public class AiInvocationLog : EntityBase
{
    /// <summary>
    /// 调用 ID。
    /// </summary>
