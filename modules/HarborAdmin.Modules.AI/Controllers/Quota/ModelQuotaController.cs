...
public sealed class ModelQuotaController(QuotaService service) : AdminCrudControllerBase<AiModelQuotaDto, PageRequest, SaveAiModelQuotaRequest>
{
    ...
    /// </summary>
    [HttpGet]
    public async Task<ActionResult<ApiResult<PagedResult<AiModelQuotaDto>>>> List([FromQuery] PageRequest query, CancellationToken cancellationToken) =>
    ...
    /// </summary>
    [HttpGet("{id:long}")]
    public async Task<ActionResult<ApiResult<AiModelQuotaDto>>> Get(long id, CancellationToken cancellationToken) =>
    ...
    /// </summary>
    [HttpPost]
    public async Task<ActionResult<ApiResult<AiModelQuotaDto>>> Create([FromBody] SaveAiModelQuotaRequest request, CancellationToken cancellationToken) =>
    ...
    /// </summary>
    [HttpPut("{id:long}")]
    public async Task<ActionResult<ApiResult<AiModelQuotaDto>>> Update(long id, [FromBody] SaveAiModelQuotaRequest request, CancellationToken cancellationToken) =>
