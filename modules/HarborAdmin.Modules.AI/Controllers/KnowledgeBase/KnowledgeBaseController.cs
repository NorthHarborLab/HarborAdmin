...
public sealed class KnowledgeBaseController(KnowledgeBaseService service) : AdminCrudControllerBase<AiKnowledgeBaseDto, PageRequest, SaveAiKnowledgeBaseRequest>
{
    /// <summary>
    /// 列出知识库。
    /// </summary>
